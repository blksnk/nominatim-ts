 ...
 * {@link JSONPlace}
 */
export declare type JSONSearchResponse<TParams extends SearchParams> = JSONPlace<TParams>[];
/**
 * ### Nominatim search response
 ...
 * {@link JSONV2Place}
 */
export declare type JSONV2SearchResponse<TParams extends SearchParams> = JSONV2Place<TParams>[];
/**
 * ### Nominatim search response
 ...
 */
export declare type NominatimSearchResponse<TParams extends SearchParams> = TParams["format"] extends "json" ? JSONSearchResponse<TParams> : TParams["format"] extends "geojson" ? GeoJSONSearchResponse<TParams> : TParams["format"] extends "geocodejson" ? GeocodeJSONSearchResponse<TParams> : JSONV2SearchResponse<TParams>;
