 ...
 * {@link JSONPlace}
 */
export declare type JSONLookupResponse<TParams extends NominatimLookupParams> = JSONPlace<TParams>[];
/**
 * ### Nominatim lookup response
 ...
 * {@link JSONV2Place}
 */
export declare type JSONV2LookupResponse<TParams extends NominatimLookupParams> = JSONV2Place<TParams>[];
/**
 * ### Nominatim lookup response
 ...
 * {@link GeoJSONPlace}
 */
export declare type GeoJSONLookupResponse<TParams extends NominatimLookupParams> = {
 ...
 */
export declare type GeocodeJSONLookupResponse<TParams extends NominatimLookupParams> = {
    type: "FeatureCollection";
    geocoding: {
        version: string;
        attribution: string;
 ...
 */
export declare type NominatimLookupResponse<TParams extends NominatimLookupParams> = TParams["format"] extends "json" ? JSONLookupResponse<TParams> : TParams["format"] extends "geojson" ? GeoJSONLookupResponse<TParams> : TParams["format"] extends "geocodejson" ? GeocodeJSONLookupResponse<TParams> : JSONV2LookupResponse<TParams>;
