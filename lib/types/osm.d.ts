 ...
 */
export declare type OSMTagKey = "boundary" | "place" | "building" | "tourism" | "amenity" | "highway" | "shop" | "leisure" | "office" | string;
/**
 * Value of the main OSM Tag
 * @see
 * {@link https://wiki.openstreetmap.org/wiki/Tags#key=value_syntax}
 */
export declare type OSMTagValue = "house" | "detached" | "information" | "post_office" | "service" | "administrative" | "suburb" | "pedestrian" | "historic" | string;
/**
