...
export declare type JSONPlace<TParams extends CommonOutputParams> = {
   ...
   */
  geojson?: TParams["polygon_geojson"] extends 1
    ? GeoJSONGeometry<number>
    : never;
  /**
 ...
 */
export declare interface JSONV2Place<TParams extends CommonOutputParams>
  extends Omit<JSONPlace<TParams>, "class"> {
  /**
   * @see
...
export declare type GeoJSONPlace<TParams extends CommonOutputParams> = {
  ...
  geometry: GeoJSONGeometry<
    number,
    TParams["polygon_geojson"] extends 1 ? unknown : "Point"
  >;
  /**
...
export declare type GeocodeJSONPlace<TParams extends CommonOutputParams> = {
  ...
  properties: {
    geocoding: {
       ...
       * Only with `addressdetails=1`
       */
      admin?: TParams["addressdetails"] extends 1
        ? GeocodeJSONAdminLevel
        : never;
    };
  };
