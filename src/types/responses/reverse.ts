 ...
 * {@link JSONPlace}
 */
export declare interface JSONReverseResponse<
  TParams extends NominatimReverseParams,
> extends JSONPlace<TParams> {}
 ...
 * {@link JSONV2Place}
 */
export declare interface JSONV2ReverseResponse<
  TParams extends NominatimReverseParams,
> extends JSONV2Place<TParams> {}
 ...
 * {@link GeoJSONPlace}
 */
export declare interface GeoJSONReverseResponse<
  TParams extends NominatimReverseParams,
> {
 ...
 */
export declare interface GeocodeJSONReverseResponse<
  TParams extends NominatimReverseParams,
> {
  type: "FeatureCollection";
  geocoding: {
 ...
 */
export declare type NominatimReverseResponse<
  TParams extends NominatimReverseParams,
> = TParams["format"] extends "json"
  ? JSONReverseResponse<TParams>
  : TParams["format"] extends "geojson"
  ? GeoJSONReverseResponse<TParams>
  : TParams["format"] extends "geocodejson"
  ? GeocodeJSONReverseResponse<TParams>
  : JSONV2ReverseResponse<TParams>;
